  ...
  const getAvaiableSlots = async () => {
    ...
    for (let i = 0; i < 7; i++) {
      ...
      while (currentDate < endTime) {
        ...
        // Increament current time by 30 mintutes
        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <div className="flex-1 border border-gray-500 rounded-lg p-8 py-7 bg-white mx-2 sm:mx-0 mt-[-80px] sm:mt-0">
              ...
              {/* -----Doctor about----- */}
              <div>
                <p className="flex items-center gap-1 text-5m font-medium text-gray-900 mt-3">
          ...
          <div className="sm:ml-72 sm:pl-4  mt-4 font-medium text-gray-700">
            ...
            <button
              ...
              className="bg-primary text-white text-md font-light px-14 py-3 rounded-full my-6"
            >
              Book an appointment
            </button>
          </div>
